...
export function GaugeCard({
  ...
  return (
    <div
      className={`p-3 md:p-5 flex flex-col justify-between gap-3 md:gap-6 bg-[#1E333B] rounded w-[180px] md:w-[314px] ${className}`}
      style={{
        height: '100%'
      }}
    >
      ...
      <p className="text-xs md:text-base h-full overflow-hidden">{texts[0]}</p>
    </div>
  )
}
